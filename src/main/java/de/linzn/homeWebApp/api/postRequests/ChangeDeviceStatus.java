...
public class ChangeDeviceStatus implements IResponseHandler {
    @Override
    public IHtmlTemplate buildResponse(List<String> inputList) {
        ...
        STEMSystemApp.LOGGER.DEBUG(Color.GREEN + "[WEBAPP_API-SERVER] Post Request: LightControl::" + deviceName);
