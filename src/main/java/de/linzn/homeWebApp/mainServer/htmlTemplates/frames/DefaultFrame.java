...
public class DefaultFrame {
    ...
    public DefaultFrame(String title, String divName, boolean script, String divRequestURL, int time) {
        frameBuilder.append("<div class=\"dash-unit\">\n" +
                "                    <dtitle>" + title + "</dtitle>\n" +
                "                    <hr>\n" +
                "                    <div id=\"" + divName + "\">\n" +
                "                        <div class=\"cont\">\n" +
    ...
    public DefaultFrame(String title, String customCode) {
        frameBuilder.append("<div class=\"dash-unit\">\n" +
                "                    <dtitle>" + title + "</dtitle>\n" +
                "                    <hr>\n"
                + customCode +
    ...
    public DefaultFrame(MenuFrame menuFrame) {
        frameBuilder.append(menuFrame.getFrame());
    }
